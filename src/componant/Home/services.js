                ...
                <div className='row align-items-center'>
                  <div className='col-xl-4 col-lg-5 col-md-6' >
                    <div className='services-item text-center'>
                      ...
                      <Link to={item.link} className='btn btn-primary' data-aos="fade-up">Read More</Link>
                    </div>
                  </div>
